...
public class Trainer extends javax.swing.JFrame {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		jTable1.setModel(new afficherUsers(usersessionn.getUserByNameAndRole(a.getText(), "trainer")));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
		...
		jTable1.setModel(new afficherUsers("trainer"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	User ggg = new User();
                new Trainer(ggg).setVisible(true);
            }
        });
    }
