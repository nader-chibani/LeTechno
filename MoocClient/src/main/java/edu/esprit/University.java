...
public class University extends javax.swing.JFrame {
	...
	public University(User usr) {
		...
		jTable1.setModel(new afficherUniversity());
	}
	...
	private void initComponents() {
		...
		jLabel3.setText("List of University");
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		universitySession.DeleteUniversity(x);
	...
	private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		IUniversitySession universitySession = (IUniversitySession) Locator.lookup("UniversitySession",
				IUniversitySession.class);
		jTable1.setModel(new afficherUniversity(universitySession.findUniversityByName(a.getText())));
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(University.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				User ggg = new User();
				new University(ggg).setVisible(true);
			}
		});
	}
